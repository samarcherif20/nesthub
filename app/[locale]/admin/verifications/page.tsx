            ...
            <table className="w-full text-left">
              <thead className="sticky top-0 z-10">
                <tr className="bg-indigo-50/50 dark:bg-indigo-900/10 border-b border-indigo-100 dark:border-indigo-900/30">
                  <th className="px-5 py-3 text-[10px] font-bold text-indigo-400 dark:text-indigo-500 uppercase tracking-wider text-center">
                    {t("table.user")}
                  </th>
                  <th className="px-5 py-3 text-[10px] font-bold text-indigo-400 dark:text-indigo-500 uppercase tracking-wider text-center">
                    {t("table.role")}
              ...
              <tbody className="divide-y divide-slate-50 dark:divide-slate-800/60">
                {requests.map((req) => {
                  // Detect document type correctly
                  const isPassport =
                  ...
                  return (
                    ...
                    >
                      ...
                      {/* Rôle */}
                      <td className="px-5 py-3.5 text-center">
                        <span className="inline-flex items-center justify-center text-xs font-semibold px-2.5 py-1 rounded-full bg-violet-50 dark:bg-violet-900/20 text-violet-600 dark:text-violet-400 border border-violet-200 dark:border-violet-800 uppercase min-w-[80px]">
                      ...
                      <td className="px-5 py-3.5 text-center">
                        <span
                          className={`inline-flex items-center justify-center text-xs font-semibold px-2.5 py-1 rounded-full min-w-[80px] ${
                            isPassport
                      ...
                      {/* Statut */}
                      <td className="px-5 py-3.5 text-center">
                        <span className="inline-flex items-center justify-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-bold bg-amber-50 dark:bg-amber-900/20 text-amber-600 dark:text-amber-400 border border-amber-200 dark:border-amber-800 min-w-[100px]">
                      ...
                      <td className="px-5 py-3.5 text-center">
                        <Link
                          ...
                          className="inline-flex items-center justify-center gap-1.5 px-3.5 py-2 rounded-xl bg-gradient-to-r from-indigo-500 to-violet-600 hover:from-indigo-600 hover:to-violet-700 text-white text-xs font-semibold shadow-sm transition-all active:scale-[0.98] min-w-[120px]"
                        >
                          {t("processRequest")}
