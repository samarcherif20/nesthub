...
export const updateListingSchema = z.object({
  ...
  type: z
    .enum(["APARTMENT", "VILLA", "STUDIO", "DUPLEX", "HOUSE", "ROOM"])
    .optional(),
  ...
  numberOfKitchens: z.number().min(1).max(5).optional(),
  maxGuests: z.number().min(0).max(30).nullable().optional(),
  surfaceArea: z.number().positive().optional(), // Optionnel en mise à jour
